...
export function ProjectDetail({ project, onBack }: ProjectDetailProps) {
  ...
  const handleExport = async () => {
    setIsExporting(true);
    try {
      const csvContent = await ExportProjectSummary(currentProject.id);
      const filename = generateExportFilename('project', currentProject.name.replace(/\s+/g, '-').toLowerCase());
