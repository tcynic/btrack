...
export function CreateTemplate(arg1:number,arg2:string):Promise<store.Template>;
...
export function GetCapacityUtilization(arg1:string,arg2:string):Promise<Array<store.CapacityWeek>>;

export function GetDashboardData(arg1:number,arg2:number):Promise<Array<store.DashboardWeekData>>;
...
export function GetMonthlyTrends(arg1:number):Promise<Array<store.MonthlyTrend>>;
...
export function GetTemplate(arg1:number):Promise<store.Template>;

export function GetTemplates():Promise<Array<store.Template>>;

export function GetVarianceReport(arg1:string,arg2:string):Promise<Array<store.VarianceReport>>;
